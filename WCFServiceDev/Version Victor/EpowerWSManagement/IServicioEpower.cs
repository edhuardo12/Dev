...
namespace EpowerWSManagement
{
    ...
    {
        [OperationContract]
        ResultadoAccion SaveDocument(string User, string Password, int appId, int tipeId, int queryId, Datos[] data, Datos[] dataSet, Contenido[] contenido, int pos);
        [OperationContract]
        ResultadoAccion SaveDocumentTest(string User, string Password, int appId, int tipeId, int queryId, Datos[] data, Datos[] dataSet, Contenido[] contenido, int pos);
        [OperationContract]
    ...
    public class Resultado
    {
        ...
        [DataMember]
        public List<ResultDetalle> ItemsDetalle { get; set; }
        [DataMember]
    ...
    {
        public string _ruta, _cejilla, _etiqueta;
        [DataMember]
        public string ruta
        {
            get { return _ruta; }
